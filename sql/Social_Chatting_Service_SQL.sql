...
CREATE TABLE MESSAGE (
    ...
    FOREIGN KEY (MESSAGE_RECEIVER) REFERENCES USER(USERID)
);
...
-- 메세지 저장
INSERT INTO MESSAGE (MESSAGE_ID, MESSAGE_CONTENT, MESSAGE_SENDTIME, MESSAGE_SENDER, MESSAGE_RECEIVER)
VALUES (?, NOW(), ?, ?);

INSERT INTO MESSAGE (MESSAGE_CONTENT, MESSAGE_SENDTIME, MESSAGE_SENDER, MESSAGE_RECEIVER)
VALUES ('user01: 하이', now() , 'user01', 'user03');
